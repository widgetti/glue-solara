<template>
  <div class="glue-layer-scatter">
    ...
    <div>
      ...
      <v-switch
        v-model="glue_state.visible"
        hide-details
        style="margin-top: 0"
      />
    </div>
    <template v-if="glue_state.visible">
      <!-- <div>
      ...
      <div>
        <v-subheader class="pl-0 slider-label">size</v-subheader>
        <glue-throttled-slider
          wait="300"
          min="0.1"
          max="10"
          step="0.01"
          :value.sync="glue_state.size"
          hide-details
        />
      </div>
      <div>
        ...
        <glue-throttled-slider
          ...
          max="10"
          step="0.01"
          :value.sync="glue_state.size_scaling"
          hide-details
        />
      </div>
    </template>
